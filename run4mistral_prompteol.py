...
class EncoderWrapper:
    ...
    def encode(self, sentences, l2_normalize=True, is_query=True, **kwargs) -> np.ndarray:
        ...
        data_loader = DataLoader(dataset, batch_size=self.batch_size_per_gpu, shuffle=False, drop_last=False, num_workers=8, collate_fn=data_collator, pin_memory=True)
...
if __name__ == "__main__":
    ...
    template = "This sentence: \"{text}\" means [MASK]"
...
# CUDA_VISIBLE_DEVICES=6 nohup python run4mistral_prompteol.py --model_name Mistral-7B-Instruct-v0.3 --filter_ratio 1 > mistral1.log 2>&1 &
# CUDA_VISIBLE_DEVICES=7 nohup python run4mistral_prompteol.py --model_name Mistral-7B-Instruct-v0.3 --filter_ratio 2 > mistral2.log 2>&1 &
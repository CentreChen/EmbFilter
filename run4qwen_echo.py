...
if __name__ == "__main__":
    ...
    model = Qwen2ForCausalLM.from_pretrained(pretrained_model, torch_dtype=torch.float16, config=config)
...
# CUDA_VISIBLE_DEVICES=2 python run4qwen_echo.py --model_name Qwen2.5-0.5B --filter_ratio 1